...
```
You'll then be asked which example exercise you'd like to see run. You can input any number between 1 and 36 (though currently I only have workng examples for 1 through 20, as of July 2020).
